...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 21 09:47:48 2024
...
def getMeansAndSDs(population, sample, verbose = False):
    ...
    if verbose:
        ...
        print("Standard deviaton of sample =", numpy.std(sample))
...
# why red contribute wth rape? red?
...
plotDiffs(sampleSizes, diffs, "Sample SD vs Population SD, Temperatures",
          label = "High temps")
...
def compareDists():
    ...
    plotDiffs(sampleSizes, udiffs, "Sample SD vs Population SD",
                  "Unform population")

    plotDiffs(sampleSizes, ndiffs, "Sample SD vs Population SD",
                  "Normal population") 
    
    plotDiffs(sampleSizes, ediffs, "Sample SD vs Population SD",
