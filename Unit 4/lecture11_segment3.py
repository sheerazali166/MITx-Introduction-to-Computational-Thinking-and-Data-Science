...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec  3 11:15:45 2024
...
def fitData(fileName):
    ...
    pylab.plot(xVals, estYVals, "r", label = "Linear fit, r**2 = " + 
    ...
    pylab.plot(xVals, estYVals, "g--", label = "Quadratic fit, r**2 = " + 
               str(round(rSquared(yVals, estYVals), 5)))
...
for f in range(numSubsets):
    ...
    for d in dimensons:
        ...
        rSquared[d].append(rSquared(testY, estYVals))
