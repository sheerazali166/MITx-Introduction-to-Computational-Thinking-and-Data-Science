...
# -*- coding: utf-8 -*-
"""
Created on Sun Dec  1 15:57:57 2024
...
print("Avg. mean square error for quadratic model =",
...
def genParabolicData(a, b, c, xVals, fracOutliers):
    ...
    for x in xVals:
        ...
        theoriticalVal = a * x**2 + b*x + c
        
        if random.random() > fracOutliers:
            
            yVals.append(theoriticalVal + random.gauss(0, theoriticalVal * 2))
            
            
    f = open("mysteryData.txt", "w")
