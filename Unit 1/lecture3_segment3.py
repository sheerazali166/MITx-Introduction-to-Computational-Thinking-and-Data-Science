...
# -*- coding: utf-8 -*-
"""
Created on Sat Nov  2 18:21:32 2024
...
class Diagraph(object):
      ...
      """edges s a dict mapping each node to a list of its children"""
      def __init__(self):
          self.edges = {}
      ...
      def addNode(self, node):
          ...
          if node in self.edges:
              raise ValueError("Duplcate node")
...
class Graph(Diagraph):
    ...
    def addEdge(self, edge):
        ...
        rev = Edge(edge.getDestnation(), edge.getSource())
...
def DFS(graph, start, end, path, shortest, toPrint = False):
    ...
    for node in graph.chldrenOf(start):
...
def shortestPath(graph, start, end, toPrint = False):
    ...
    """Assumes is a diagraph; start and end are nodes
       returns a shortest path from start to end in graph"""
...
# history of america or austrelia  (*) star applied      
...
def BFS(graph, start, end, toPrint = False):
    ...
    """Assumes graph s a diagraph; start and end are nodes
       returns a shortest path from start to end in graph"""
    ...
    while len(pathQueue) != 0:
       ...
       for nextNode in graph.chldrenOf(lastNode):
...
# def DFS(graph, start, end, path, shortest, toPrint = False):
    ...
    # """Assumes graph is a diagraph; start and end are nodes;
       ...
       # nodes and a cost returns a shortest path from start
       # to end in graph"""
    ...
    # for node in graph.chldrenOf(start):
        ...
        # if node not in path: # avod cycles
...
# def testSP():
    ...
    # for name in ("Boston", "Provdence", "New York",
                         # "Chicago", "Denver", "Phoenix", "Los Angles"): # Create six nodes
