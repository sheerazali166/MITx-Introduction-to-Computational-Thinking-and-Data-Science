...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec  9 19:10:59 2024
...
# set font size for labels on x-axes
...
animals = [cobra, rattlesnack, boa, chicken, alligator,
               dartFrog, salmon, python]


def compareAnimals(animals, precision):
    
    """ Assumes animals is a list of animals, precision an int >= 0
        Builds a table of Euclidean distance between each anmal """
    ...
    table = pylab.table(rowLabels=rowLabels,
                        colLabels=columnLabels, cellText=tableVals,
