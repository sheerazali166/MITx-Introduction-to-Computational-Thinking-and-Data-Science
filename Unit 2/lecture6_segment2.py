...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov  5 18:07:58 2024
...
class Field(object):
    ...
    def moveDrunk(self, drunk):
        ...
        # use move method of locaton to get new location
...
def simWalks(numSteps, numTrials, dClass):
    ...
    """Assumes numSteps an int >= 0, numTrials an int > 0, dClass a subclass
       of Drunk simulates numTrials walks of numSteps steps each. returns a
       list of the final distances for each trials."""
...
def drunkTest(walkLengths, numTrials, dClass):
    ...
    """Assumes walk1Lengths a sequence of ints >= 0 numTrials an int > 0,
       dClass a subclass of drunk for each numbers of steps in walkLengths,
...
drunkTest((10, 1000, 10000, 100000), 100, UsualDrunk)
